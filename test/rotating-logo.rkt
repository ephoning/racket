...
(define plt-logo (bitmap/file "/Users/honine/Pictures/88px-scheme-logo.png"))
...
(define (numbers->image ns)
  ...
  (define (numbers->string ns)
    (_numbers->string ns ""))
  (text/font (numbers->string ns) 10 textColor #f 'modern 'normal 'normal #f))
...
;; todo: commoditize getters/setters on a world instance
